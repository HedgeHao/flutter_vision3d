...
class EfficientNetView extends GetView<EfficientNetController> {
  const EfficientNetView({Key? key}) : super(key: key);
        ...
        Expanded(
          ...
          children: [
            Container(
                ...
                width: EfficientNetController.frameWidth,
            ...
            GetBuilder<EfficientNetController>(builder: (controller) => Text(controller.displayText)),
          ],
        ))
      ]),
    );
