...
class HandDetectionView extends GetView<HandDetectionController> {
  const HandDetectionView({Key? key}) : super(key: key);
        ...
        Expanded(
          ...
          children: [
            Container(
                ...
                width: 640,
                height: 480,
                child: GetBuilder<HandDetectionController>(
                  builder: (controller) {
                    return controller.cam == null
                        ? const SizedBox()
                        : Stack(children: [
                            Texture(textureId: controller.cam!.rgbTextureId),
                            CustomPaint(painter: HandPainter(controller.points)),
                          ]);
                  },
                ))
          ],
